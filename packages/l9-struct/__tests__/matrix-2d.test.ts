...
describe("Matrix2D", () => {
  ...
  it("should fill", () => {
    ...
    expect(Array.from(image.get(2, 10))).toEqual([255, 255, 255, 255]);
  })
  ...
  it("mutate pixel", () => {
    ...
    expect(Array.from(image.get(1, 10))).toEqual([255, 0, 0, 0]);
  })
  ...
  it("return array", () => {
    ...
    expect(Array.from(image.get(1, 10))).toEqual([0, 255, 255, 255]);
  })
  ...
  it("changes color with hex", () => {
    ...
    expect(Array.from(image.get(1, 10))).toEqual([255, 0, 0, 255]);
  })
